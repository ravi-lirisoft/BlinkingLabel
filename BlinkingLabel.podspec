...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = ' https://github.com/ravi-lirisoft/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ravi Prajapat' => 'ravi.prajapat@lirisoft.com' }
  s.source           = { :git => 'https://github.com/Ravi Prajapat/BlinkingLabel.git', :tag => s.version.to_s }
